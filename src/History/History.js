  ...
  return (
    <div className="History-box">
      {// Ful lösning för jag får det inte att fungera annars
       // Tab 1
       options1[0] === 0 && IconNoCross(Data[0].alt[0][0], Data[0].image[0][0])}
      ...
      {options1[1] === 0 && IconNoCross(Data[0].alt[1][0], Data[0].image[1][0])}
      {options1[1] === 1 && Icon(Data[0].alt[1][1], Data[0].image[1][1], removeIcon2)}


      {// Tab 2
       options2[0] === 0 && IconNoCross(Data[1].alt[0][0], Data[1].image[0][0])}
      {options2[0] === 1 && Icon(Data[1].alt[0][1], Data[1].image[0][1], removeIcon3)}

      {options2[1] === 0 && IconNoCross(Data[1].alt[1][0], Data[1].image[1][0])}
      ...
      {options2[2] === 0 && IconNoCross(Data[1].alt[2][0], Data[1].image[2][0])}
      ...
      {// Tab 3
       options3[0] === 0 && IconNoCross(Data[2].alt[0][0], Data[2].image[0][0])}
      ...
      {options3[1] === 0 && IconNoCross(Data[2].alt[1][0], Data[2].image[1][0])}
      ...
      {// Tab 4
       options4[0] === 0 && IconNoCross(Data[3].alt[0][0], Data[3].image[0][0])}
      {options4[0] === 1 && Icon(Data[3].alt[0][1], Data[3].image[0][1], removeIcon8)}

      {options4[1] === 0 && IconNoCross(Data[3].alt[1][0], Data[3].image[1][0])}
