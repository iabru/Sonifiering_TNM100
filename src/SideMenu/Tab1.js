  ...
  return (
    <div>
        <article className="Tab1">
          ...
          <div onClick={() => {setOption(1); options[0] = 1; localStorage.setItem("tab1Option", JSON.stringify(options));}}>
            {option !== 1 && Val(Data[0].alt[0][1], Data[0].image[0][1])}
          </div>

          {option === 2 && Valt(Data[0].alt[0][2], Data[0].image[0][2])}
          <div onClick={() => {setOption(2); options[0] = 2; localStorage.setItem("tab1Option", JSON.stringify(options));}}>
            {option !== 2 && Val(Data[0].alt[0][2], Data[0].image[0][2])}
          </div>

          {option === 3 && Valt(Data[0].alt[0][3], Data[0].image[0][3])}
          <div onClick={() => {setOption(3); options[0] = 3; localStorage.setItem("tab1Option", JSON.stringify(options));}}>
          ...
          <div onClick={() => {setOption2(1); options[1] = 1; localStorage.setItem("tab1Option", JSON.stringify(options));}}>
