  ...
  return (
    <div>
        <article className="Tab2">
          ...
          <div onClick={() => {childToParent(Data[1].alt[0][0]);setOption(0); options[0] = 0; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
            {option !== 0 && Val(Data[1].alt[0][0], Data[1].image[0][0])}
          </div>

          {option === 1 && Valt(Data[1].alt[0][1], Data[1].image[0][1])}
          <div onClick={() => {childToParent(Data[1].alt[0][1]);setOption(1); options[0] = 1; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
          ...
          <div onClick={() => {childToParent(Data[1].alt[1][0]);setOption2(0); options[1] = 0; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
            {option2 !== 0 && Val(Data[1].alt[1][0], Data[1].image[1][0])}
          </div>

          {option2 === 1 && Valt(Data[1].alt[1][1], Data[1].image[1][1])}
          <div onClick={() => {childToParent(Data[1].alt[1][1]);setOption2(1); options[1] = 1; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
            {option2 !== 1 && Val(Data[1].alt[1][1], Data[1].image[1][1])}
          </div>

          {option2 === 2 && Valt(Data[1].alt[1][2], Data[1].image[1][2])}
          <div onClick={() => {childToParent(Data[1].alt[1][2]);setOption2(2); options[1] = 2; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
          ...
          <div onClick={() => {childToParent(Data[1].alt[2][0]);setOption3(0); options[2] = 0; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
            {option3 !== 0 && Val(Data[1].alt[2][0], Data[1].image[2][0])}
          </div>

          {option3 === 1 && Valt(Data[1].alt[2][1], Data[1].image[2][1])}
          <div onClick={() => {childToParent(Data[1].alt[2][1]);setOption3(1); options[2] = 1; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
            {option3 !== 1 && Val(Data[1].alt[2][1], Data[1].image[2][1])}
          </div>

          {option3 === 2 && Valt(Data[1].alt[2][2], Data[1].image[2][2])}
          <div onClick={() => {childToParent(Data[1].alt[2][2]);setOption3(2); options[2] = 2; localStorage.setItem("tab2Option", JSON.stringify(options));}}>
